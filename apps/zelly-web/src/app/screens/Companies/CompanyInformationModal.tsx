...
export const CompanyInformationModal: FC<Props> = ({isOpen, setIsCompanyModalOpen, currentCompany}) => {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 overflow-hidden" onClose={setIsCompanyModalOpen}>
                        ...
                        <div className="mt-6 sm:ml-6 sm:flex-1">
                          <div>
                            <div className="flex items-center">
                              <h3
                                className="text-xl font-bold text-gray-900 sm:text-2xl">{currentCompany.companyNameEnglish}</h3>
                    ...
                    <div className="px-4 py-5 sm:px-0 sm:py-0">
                      <dl className="space-y-8 sm:space-y-0 sm:divide-y sm:divide-gray-200">
                        ...
                        <div className="sm:flex sm:px-6 sm:py-5">
                          ...
                          <dd
                            className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 sm:ml-6">{currentCompany.industry}</dd>
                        </div>
                        <div className="sm:flex sm:px-6 sm:py-5">
                          <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0 lg:w-48">
                            Last CO<sub>2</sub>
