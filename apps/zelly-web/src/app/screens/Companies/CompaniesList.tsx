...
export const CompaniesList = () => {
    ...
    const {
      data: favouriteCompanies, refetch
    } = useUserCompanies();
    ...
    const {
      mutateAsync: mutateUnfollow,
      isLoading: isMutationUnfollowLoading
    } = useMutation('removeCompanyFromUser', (company: CompanyId) => userService.removeCompanyFromUser(company), {
      onSuccess: (data: CompanyProperties[]) => {
        refetch();
      },
      onError: (err) => {
    ...
    return (
      <>
          ...
          <div className='sm:flex sm:items-center'>
            <div className='sm:flex-auto'>
              ...
              <p className='mt-2 text-sm text-gray-700'>
                A list of all the companies in the Zelly database including their name, industry,
                country and last CO<sub>2</sub> emission numbers.
              </p>
            </div>
          </div>
                      ...
                      data.map((company: CompanyProperties) => (
                        <tr key={company.id}>
                          ...
                          <td
                            ...
                            {isMutationLoading || isMutationUnfollowLoading ? <p>Loading...</p> :
                              <AddToFavouritesButton onShowCompanyDetails={() => showCompanyModal(company)}
        ...
        <CompanyInformationModal favouriteCompanies={favCompaniesIds} setIsCompanyModalOpen={setIsCompanyModalOpen}
