  ...
  return (
    <div className="lg:flex">
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        <div className="py-12 bg-emerald-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
          <div className="cursor-pointer flex items-center">
            <div>
              <svg
                className="w-10 text-emerald-500"
            ...
            <div className="text-2xl text-emerald-800 tracking-wide ml-2 font-semibold">
              Zelly
            </div>
          </div>
        </div>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-emerald-500"
      ...
      <div className="hidden lg:flex items-center justify-center bg-emerald-100 flex-1 h-screen">
