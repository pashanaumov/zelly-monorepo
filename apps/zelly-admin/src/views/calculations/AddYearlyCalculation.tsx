...
export function AddYearlyCalculation() {
  ...
  const buttonDisabled =
    ...
    Object.values(yearlyCalculationData).includes('') ||
    Object.values(quarterlyEsgData).includes('');
  ...
  const yearlyDataPayload: CompanyAddYearlyDataPayload | null = useMemo(() => {
    if (!buttonDisabled && routeState.companyId) {
      return {
    ...
    return null;
  }, [buttonDisabled, quarterlyEsgData, routeState.companyId, yearlyCalculationData]);
  ...
  return (
    <div className="mb-32">
      {!routeState.companyId && <CompaniesListDropdownList onSetSelectedCompany={_setSelectedCompany} />}
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
                    ...
                    disabled={true}
                    value={selectedCompany?.companyNameEnglish || routeState.companyName || ''}
                  />
                </div>
              </div>
