...
import { useAddNewCompany } from '@zelly/core/queries/admin/addCompany';
...
export const AddNewCompany = () => {
  const { addNewCompany, isLoading } = useAddNewCompany(onClearForm);
          ...
          <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
              <div className="relative flex py-5 items-center">
                ...
                <span className="flex-shrink mx-4 text-gray-400">New company</span>
                <div className="flex-grow border-t border-gray-400"></div>
              </div>
